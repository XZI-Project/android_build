...
""" % bcb_dev)
  ...
  #Print ASCII
  script.Print("------------------------------------------------");
  script.Print("|                 XziProject                    ");
  script.Print("------------------------------------------------");
  script.Print("------------------------------------------------");
  script.Print("|               By:-Mikazuuu07                 |");
  script.Print("------------------------------------------------");
  script.Print(" ")
  ...
  if target_info.GetBuildProp("ro.xzi.display.version") is not None:
    buildid = target_info.GetBuildProp("ro.xzi.display.version")
    ...
    device = target_info.GetBuildProp("ro.xzi.device")
